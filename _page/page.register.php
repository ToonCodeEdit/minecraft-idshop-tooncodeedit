<html lang="th">
 <head>
  ...
  <style type="text/css">
	 body{ background-image:url("https://hdwallsource.com/img/2019/7/obduction-game-screenshot-wallpaper-68026-70348-hd-wallpapers.jpg"); background-repeat:no-repeat; background-position:center; background-size:cover; padding:10px;}
    body{ background-image:url("https://hdwallsource.com/img/2019/7/obduction-game-screenshot-wallpaper-68026-70348-hd-wallpapers.jpg"); background-repeat:no-repeat; background-position:center; background-size:cover; padding:10px;}
	{
  ...
  <body>
	<body background="https://hdwallsource.com/img/2019/7/obduction-game-screenshot-wallpaper-68026-70348-hd-wallpapers.jpg">
      ...
      <div class="text-center mt-5 mb-5" style="color: black;"><?php echo date('Y'); ?>  &copy; | <?php echo $config['name']; ?><br>Powered by <a href="#">ToonCodeEdit</a></div>
     </footer>
  </body>
</html>
